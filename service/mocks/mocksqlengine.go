...
// Source: github.com/sukhajata/portsapi/service/pkg/db (interfaces: SQLEngine)
...
// QueryTextColumn mocks base method
func (m *MockSQLEngine) QueryTextColumn(arg0 string, arg1 ...interface{}) ([]string, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "QueryTextColumn", varargs...)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// QueryTextColumn indicates an expected call of QueryTextColumn
func (mr *MockSQLEngineMockRecorder) QueryTextColumn(arg0 interface{}, arg1 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0}, arg1...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryTextColumn", reflect.TypeOf((*MockSQLEngine)(nil).QueryTextColumn), varargs...)
}
